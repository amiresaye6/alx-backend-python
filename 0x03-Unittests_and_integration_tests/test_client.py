...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self, mock_json):
        """
        This method unit-tests GithubOrgClient.public_repos.
        It tests that the list of repos is what you expect from the chosen
        payload.
        It also tests that the mocked property and the mocked get_json were
        called once.
        """
